...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String bodypart = JOptionPane.showInputDialog("type in a bodypart");
		...
		JOptionPane.showMessageDialog(null,
				" Piranhas are more " + adjective
						...
						+ ". Whatever you do, if you have\n"
						+ "an open wound, try to find another way to get back to " + place + ". Good luck! ");
